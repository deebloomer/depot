...
Product.create({title: "WexDubZ1",
    description: "Wexford (Redmond Sq), Oylgate, Enniscorthy, Ferns",
    image_url: "cs.jpg",
    price: 6.00})

Product.create({title: "WexDubZ2",
    description: "Camolin, Gorey, Arklow (Old Dublin Rd)*** ",
    image_url: "ruby.jpg",
    price: 6.00})
...
Product.create({title:"DubWexZ3",
    description:"Ferns, Enniscorthy, Oylgate, Wexford (Redmond Sq)",
    price:6.00})
